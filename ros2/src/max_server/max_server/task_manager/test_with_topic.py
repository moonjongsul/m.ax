...
class TaskRecognizerNode(Node):
    def __init__(self):
        ...
        timer_group2 = MutuallyExclusiveCallbackGroup()
        ...
        #     1.0, self.inference, callback_group=timer_group2
        # )
    ...
    def _on_buffer_tick(self):
        ...
        self.get_logger().info(f"timer: {buf_len}")
    ...
    def inference(self):
        ...
        parsed = _format_response(parsed)
